...
L["FlightTimeContribute"] = "Es stehen %s Flugzeiten zur Verfügung, die zur Verbesserung des Addons beitragen könnten. Gib \"/inflight export\" ein, um sie zu exportieren."
